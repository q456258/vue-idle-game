        ...
        return {
            ...
            questList: {
                ...
                3: {
                    name: '击败训练假人精英',
                    category: 'newbie',
                    desc: '接下来击败一只训练假人精英吧, 在游戏界面中间位置, 切换"精英"区, 再点击"开始战斗"。失败了不要紧, 怪物不会回血! 每次被击败后等级会提升5级',
                    target: '击败训练假人精英',
                    lv: 5,
                    reqs: [['slain', 3, 1]],
                ...
                4: {
                    name: '击败高级训练假人',
                    category: 'newbie',
                    desc: '试着击败一只高级训练假人吧, 6级开始, 普通区的怪物将转换为高级训练假人, 拥有比训练假人更强的属性。',
                    target: '击败高级训练假人',
                    lv: 5,
                    reqs: [['slain', 2, 1]],
                ...
                5: {
                    name: '击败高级训练假人精英',
                    category: 'newbie',
                    desc: '击败1只高级训练假人精英吧, 比起普通区怪物, 精英一般会拥有一个技能。',
                    target: '击败高级训练假人精英',
                    lv: 10,
                    reqs: [['slain', 4, 1]],
                ...
                6: {
                    name: '毕业',
                    category: 'newbie',
                    desc: '在游戏界面中间位置, 切换"BOSS"区! BOSS类怪物奖励非常丰富! 每次被击败后等级会一次性提升10级',
                    target: '击败导师',
                    lv: 10,
                    reqs: [['slain', 5, 1]],
                ...
                11: {
                    name: '击败杂斑野猪',
                    category: 'newbie',
                    desc: '击败一只杂斑野猪, 克罗莫丹11-15级, 图标为棕色骷髅头的怪物为杂斑野猪。',
                    target: '击败杂斑野猪',
                    lv: 10,
                    reqs: [['slain', 11, 1]],
                ...
                12: {
                    name: '击败杂斑野猪精英',
                    category: 'newbie',
                    desc: '击败五只杂斑野猪精英, 克罗莫丹11-15级, 图标为银色骷髅头的怪物为杂斑野猪精英。精英比起普通怪物会多出一个技能, 杂斑野猪精英的技能是愤怒之气, 可提升20%攻击力, 20%暴击率, 持续20秒',
                    target: '击败5只杂斑野猪精英',
                    lv: 15,
                    reqs: [['slain', 13, 5]],
