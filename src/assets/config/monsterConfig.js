export const monsterConfig = {
    data() {
        return {
            ...
            monsterZone: [
                {name:'晴风村 (上) ', minLv:0, maxLv:10, imgSrc: './icons/maps/fairbreezeValley.jpg'},
                {name:'晴风村 (下) ', minLv:11, maxLv:20, imgSrc: './icons/maps/fairbreezeValley.jpg'},
                {name:'洛克莫丹 (上) ', minLv:21, maxLv:30, imgSrc: './icons/maps/LochModan.jpg'},
                {name:'洛克莫丹 (下) ', minLv:31, maxLv:40, imgSrc: './icons/maps/LochModan.jpg'},
                {name:'艾尔文森林 (上) ', minLv:41, maxLv:50, imgSrc: './icons/maps/ElwynnForest.jpg'},
                {name:'艾尔文森林 (下) ', minLv:51, maxLv:60, imgSrc: './icons/maps/ElwynnForest.jpg'},
                {name:'西部荒野 (上) ', minLv:61, maxLv:70, imgSrc: './icons/maps/Westfall.jpg'},
                {name:'西部荒野 (下) ', minLv:71, maxLv:80, imgSrc: './icons/maps/Westfall.jpg'},
                {name:'千针石林 (上) ', minLv:81, maxLv:90, imgSrc: './icons/maps/ThousandNeedles.jpg'},
                {name:'千针石林 (下) ', minLv:91, maxLv:100, imgSrc: './icons/maps/ThousandNeedles.jpg'},
                {name:'灼热峡谷 (上) ', minLv:101, maxLv:110, imgSrc: './icons/maps/SearingGorge.jpg'},
                {name:'灼热峡谷 (下) ', minLv:111, maxLv:120, imgSrc: './icons/maps/SearingGorge.jpg'},
                {name:'秘蓝岛 (上) ', minLv:121, maxLv:130, imgSrc: './icons/maps/AzuremystIsle.jpg'},
                {name:'秘蓝岛 (下) ', minLv:131, maxLv:140, imgSrc: './icons/maps/AzuremystIsle.jpg'},
                {name:'贫瘠之地 (上) ', minLv:141, maxLv:150, imgSrc: './icons/maps/TheBarrens.jpg'},
                {name:'贫瘠之地 (下) ', minLv:151, maxLv:160, imgSrc: './icons/maps/TheBarrens.jpg'},
                {name:'杜隆塔尔 (上) ', minLv:161, maxLv:170, imgSrc: './icons/maps/Durotar.jpg'},
                {name:'杜隆塔尔 (下) ', minLv:171, maxLv:180, imgSrc: './icons/maps/Durotar.jpg'},
                {name:'丹莫罗 (上) ', minLv:181, maxLv:190, imgSrc: './icons/maps/DunMorogh.jpg'},
                {name:'丹莫罗 (下) ', minLv:191, maxLv:200, imgSrc: './icons/maps/DunMorogh.jpg'},
                {name:'尘泥沼泽 (上) ', minLv:201, maxLv:210, imgSrc: './icons/maps/DustwallowMarsh.jpg'},
                {name:'尘泥沼泽 (下) ', minLv:211, maxLv:220, imgSrc: './icons/maps/DustwallowMarsh.jpg'},
            ],
            ...
            monster: {
                0: {
                    ...
                    template: {
                        ...
                        APCRIT: { value: 0, showValue: 0},
                        APCRITDMG: { value: 200, showValue: 0},
                        CRIT: { value: 0, showValue: '0%', },
                        CRITDMG: { value: 200, showValue: '200%', },
                        HEAL: { value: 0, showValue: 0},
                        APPEN: { value: 0, showValue: 0},
                ...
                2:{
                    name: '高级训练假人', 
                    template:{
                        MAXHP: { value: 125, showValue: 1000, },        
