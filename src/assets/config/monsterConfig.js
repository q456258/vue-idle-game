    ...
    data() {
        return {
            name: [
                ...
                {name: '训练假人1', template:1}, 
                {name: '训练假人2', template:1}, 
                {name: '训练假人', template:1}, 
                {name: '训练假人', template:1}, 
                {name: '训练假人', template:2}, 
                {name: '训练假人', template:1}, 
                {name: '训练假人', template:1}, 
                {name: '训练假人', template:2}, 
                {name: '训练假人', template:1}, 
                {name: '史莱姆41', template:1}, 
                {name: '史莱姆42', template:2}, 
                {name: '史莱姆43', template:1}, 
                {name: '史莱姆51', template:1}, 
                {name: '史莱姆62', template:2}, 
                {name: '史莱姆73', template:1}, 
                {name: '海的那边', template:2}, 
