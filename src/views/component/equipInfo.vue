    ...
    data() {
        return {
            ...
            qualityProbability: [
                ...
                [0.55, 0.85, 1, 1, 1, 1], //1普通(11-30)，精英（1-20）
                [0.45, 0.78, 0.99, 1, 1, 1], //2普通(30+)
                [0.25, 0.65, 0.97, 1, 1, 1], //3精英(21-30)
                [0.19, 0.49, 0.84, 0.99, 1, 1], //4精英(40+)，boss（1-20）
                [0.25, 0.6, 0.94, 0.99, 0.9995, 1], //5宝箱
                [0.1, 0.25, 0.57, 0.92, 0.995, 1], //6BOSS（30+）
