...
<div class="container scrollbar-morpheus-den">
    ...
    <div ref="battle" class="tab-wrap">
      ...
      <div class="tab__content">
            ...
            <p>
                ✵每一次战斗胜利提升连斩数量，死亡后归零
                <br>
                ✵每10连斩下一次战斗为精英怪，每100连斩下一次战斗为BOSS怪
            </p>
            <h3>冒险里面的图标分别代表什么？</h3>
            <p>
              <span class="box">
    ...
    <div ref="guild" class="tab-wrap">
        ...
        <div class="tab__content">
            ...
            <h3>练功房的作用是什么？</h3>
            <p>            
                ✵激活练功房功能，每一级提升1点训练效果，每100点提升一级对应属性
                <br>
                ✵随机提升生命、魔法、攻击、护甲效果
                <br>
                ✵16级 - 激活中级练功房
            ...
            <h3>中级练功房的作用是什么？</h3>
            <p>            
                ✵激活第二个练功房功能，每一级提升1点训练效果，每100点提升一级对应属性
                <br>
                ✵随机提升生命、魔法、攻击、护甲、元素伤害、能量盾效果
                <br>
                ✵16级 - 激活高级练功房
            </p>
            <h3>高级练功房的作用是什么？</h3>
            <p>            
                ✵激活第三个练功房功能，每一级提升1点训练效果，每100点提升一级对应属性
                <br>
                ✵随机提升生命、魔法、攻击、护甲、元素伤害、能量盾、力量、敏捷、智力效果
            </p>
            <h3>练功房的加速模式有什么用？</h3>
            <p>            
